...
export default function PageNave({ toggleSnow }: Props) {
   return(
      <div className="bg-gradient-to-r from-black via-gray-900 to-gray-950 backdrop-blur-lg sticky top-0 z-50 px-8 py-2 max-w-screen overflow-hidden ">
         <div className="flex flex-row items-center justify-between  text-white ">
            ...
            <div className="hidden lg:flex lg:flex-row items-center gap-4">
               <Link href='/' className="text-lg font-bold transition-all duration-500 hover:text-blue-600 cursor-pointer ">HOME</Link>
